// Test database connection using DATABASE_URL (no dotenv required)
// Run this with: node test-db-url-simple.js
...
async function testDatabaseURL() {
  ...
  try {
    ...
    if (!databaseUrl) {
      ...
      console.log('4. Set it as DATABASE_URL environment variable');
      return;
    }
    ...
    try {
      ...
      console.log('DATABASE_URL format should be: mysql://user:pass@host:port/db');
    }
