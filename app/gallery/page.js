        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {images.map((img) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-all duration-300 flex items-center justify-center pointer-events-none z-10 opacity-0 group-hover:opacity-100">
                <svg className="w-8 h-8 text-white transition-all duration-300 z-20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
